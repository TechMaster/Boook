<template>
  <div id="app" class="container">
    <el-menu class="el-menu-demo" mode="horizontal">
      ...
      <el-menu-item index="10"><router-link to="/books">Books</router-link></el-menu-item>
      <el-menu-item index="10"><router-link to="/create-book">Create Book</router-link></el-menu-item>
    </el-menu>
    <br>
